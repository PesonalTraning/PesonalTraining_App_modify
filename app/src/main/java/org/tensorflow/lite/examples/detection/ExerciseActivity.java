...
public class ExerciseActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        myButton.setOnClickListener(v -> startActivity(new Intent(ExerciseActivity.this, MainActivity.class)));

//        Button exerciseButton = findViewById(R.id.exercise_Button); //운동화면 버튼 (아마 개별운동이 될 것)
//        exerciseButton.setOnClickListener(v -> startActivity(new Intent(ExerciseActivity.this, ExerciseActivity.class)));

        Button exerciseButton = findViewById(R.id.exercise_Button); //운동화면 버튼 (아마 개별운동이 될 것)
        exerciseButton.setOnClickListener(v -> startActivity(new Intent(ExerciseActivity.this, ReportActivity.class)));

        Button routineButton = findViewById(R.id.routine_Button); //루틴 버튼
        routineButton.setOnClickListener(v -> startActivity(new Intent(ExerciseActivity.this, RoutineActivity.class)));

        Button settingButton = findViewById(R.id.setting_Button); //설정창 버튼
        settingButton.setOnClickListener(v -> startActivity(new Intent(ExerciseActivity.this, Preference.class)));
        ...
        situpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent situp_intent = new Intent(ExerciseActivity.this,NpActivity.class);
        ...
        pushupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent pushup_intent = new Intent(ExerciseActivity.this,NpActivity.class);
        ...
        squatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent squat_intent = new Intent(ExerciseActivity.this,NpActivity.class);
        ...
        pullupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent pullup_intent = new Intent(ExerciseActivity.this,NpActivity.class);
